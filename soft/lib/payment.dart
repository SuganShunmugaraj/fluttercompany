...
class _PaymentState extends State<Payment> {
 ...
 bool displaySaveButton=true;
  ...
  String paymentId;
  addAmount(amount) async {
    var paymentReceived = int.parse(amount);

    print(this.paymentId);

    var response = await http.get(
        Uri.parse(BaseUrl.getInvoice + this.paymentId),
        headers: {"Accept": "application/json"});
    this.setState(() {
      var paymentList = json.decode(response.body);
      payment = paymentList['data'];
  ...
  savePaymentDetails() async {
    Map addPayment = {
      ...
      'accountscustomerName': payment[0]['customerName']['userName']
          ['firstName'],
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: RaisedButton(
                                      color: Colors.white,
                                        ...
                                        child: Text(
                                          'Submit',style: TextStyle(color: Colors.tealAccent.shade700),
                                        ),
                                    ),
                                  ),
                                ),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(payment[i]['subTotal']
                                                  .toString()),
                                              Text(
                                                payment[i]['amountPaid']
                                                    .toString(),
                                                style: TextStyle(
                                                    color: Colors.green),
                                              ),
